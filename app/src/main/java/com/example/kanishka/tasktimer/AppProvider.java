...
/**
 * Provider for TaskTimer App.This is the only that knows about {@link AppDatabase}
 */
public class AppProvider extends ContentProvider {

  static final String CONTENT_AUTHORITY = "com.example.kanishka.tasktimer.provider";
  ...
  public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
    ...
    switch (match) {
      ...
      case TIMINGS:
        ...
        Log.d(TAG, "delete: timing delete");
        break;
      ...
      case TIMINGS_ID:
        ...
        Log.d(TAG, "delete: timing id delete");
        break;
